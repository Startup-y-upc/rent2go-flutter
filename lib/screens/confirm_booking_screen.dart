      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _DetailRow(icon: Icons.location_on_outlined, label: 'Punto de encuentro', value: car.address),
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: _coverage == e.key ? kCyan : Colors.grey.shade200,
                      width: _coverage == e.key ? 2 : 1,
                    ),
                  ),
                  child: Row(
                    children: [
                              ...
                              if (e.value.popular) ...[
                                ...
                                Container(
                                  ...
                                  child: const Text('Popular',
                                      style: TextStyle(color: kCyan, fontSize: 11, fontWeight: FontWeight.bold)),
                                ),
                              ],
                            ]),
                            Text(e.value.desc,
                      ...
                      Text(
                        e.value.price == 0 ? '0 €' : '${e.value.price} €/día',
            ...
            Container(
              ...
              child: Column(
                children: [
                  _PriceRow(
                    label: '${car.price.toInt()}€ × 2 días',
                    value: '${(car.price * 2).toStringAsFixed(2)} €',
                  ),
                  _PriceRow(
                    label: 'Cobertura ${_coverages[_coverage].name}',
                    value: _coverages[_coverage].price == 0
                        ? '0 €'
                        : '${(_coverages[_coverage].price * 2).toStringAsFixed(2)} €',
                  ),
