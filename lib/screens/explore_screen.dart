                      ...
                      return Marker(
                        ...
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            child: Text(
                              '${e.value.dailyPrice.toInt()}S//día',
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('${v.dailyPrice.toInt()}S//día', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.black)),
                                ],
                              ),
                            ),
                          ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text('${vehicle.dailyPrice.toInt()}S//día', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.black)),
                    ],
                  ),
                  const SizedBox(height: 6),
                  SizedBox(
